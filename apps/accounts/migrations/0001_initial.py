    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('minecraft_uuid', models.CharField(blank=True, max_length=36, null=True, unique=True)),
                ('skin', models.ImageField(blank=True, null=True, upload_to='skins/')),
                ('skin_face', models.ImageField(blank=True, null=True, upload_to='skin_faces/')),
                ('cape', models.ImageField(blank=True, null=True, upload_to='capes/')),
                ...
                ('rank', models.CharField(default='Player', max_length=20)),
